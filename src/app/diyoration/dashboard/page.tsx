  ...
  const loadStats = useCallback(async () => {
    ...
    try {
      ...
      const [
        ...
        publishedWorksRes,
        pendingWorksRes,
        pendingWorkRevisionsRes,
        pendingChapterRevisionsRes,
        totalPurchasesRes,
        ...
        supabase.from('chapter_revisions').select('id', { count: 'exact', head: true }).eq('status', 'pending_review'),
      ...
      setStats({
        ...
        pendingRevisionModeration: (pendingWorkRevisionsRes.count || 0) + (pendingChapterRevisionsRes.count || 0),
