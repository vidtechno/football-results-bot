...
import { ReportSchema } from '../src/lib/types/directory';

describe('Bog‘lanish Directory Utilities & Validation', () => {
  ...
  it('formats Uzbek 12-digit phone numbers and short codes', () => {
    ...
    // Short emergency / call-center code
