...
export function TopupModal({
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full max-w-lg max-h-[92vh] sm:max-h-[90vh] flex flex-col bg-white rounded-t-3xl sm:rounded-3xl shadow-2xl border border-stone-200 overflow-hidden z-10">
        {/* Header */}
        <div className="flex items-center justify-between px-5 sm:px-6 py-4 border-b border-stone-100 bg-[#FAF8F5] shrink-0">
          <div className="flex items-center gap-2.5">
            <div className="w-9 h-9 rounded-xl bg-amber-100 text-amber-900 flex items-center justify-center font-bold">
              <Wallet className="w-5 h-5 text-amber-700" />
            </div>
            <div>
              <h2 id="topup-modal-title" className="text-base font-serif font-bold text-stone-900 leading-tight">
                Hisobni to‘ldirish
              </h2>
          ...
          <button
            type="button"
            onClick={onClose}
            className="w-8 h-8 rounded-full bg-stone-100 hover:bg-stone-200 text-stone-500 flex items-center justify-center transition-colors min-h-[44px] min-w-[44px]"
            aria-label="Yopish"
          >
            <X className="w-4 h-4" />
          </button>
        ...
        {/* Footer Actions */}
        <div className="p-4 sm:p-5 border-t border-stone-100 bg-[#FAF8F5] space-y-2.5 shrink-0">
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5">
            ...
            <button
              type="button"
              onClick={handleCopy}
              className={`inline-flex items-center justify-center gap-2 px-4 py-3 rounded-2xl border text-xs sm:text-sm font-bold transition-all min-h-[44px] ${
                copied
