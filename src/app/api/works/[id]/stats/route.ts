...
export async function GET(_: Request, { params }: { params: { id: string } }) {
  ...
  return NextResponse.json({ views: views || 0, readers: readers || 0, bookmarks: bookmarks || 0, completed: completed || 0, followers: followers || 0 }, { headers: { 'Cache-Control': 'no-store' } });
}
