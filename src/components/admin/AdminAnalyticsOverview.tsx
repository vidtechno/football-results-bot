...
import { Eye, Users, UserPlus, MonitorSmartphone } from 'lucide-react';

type Data = { visitorsToday:number; visitors7:number; visitors30:number; pageViewsToday:number; registrations:{today:number;seven:number;thirty:number}; devices:[string,number][]; sources:[string,number][]; topWorks:{id:string;title:string;count:number}[] };
...
export function AdminAnalyticsOverview() {
  ...
  const cards = [{l:'Bugungi tashrifchilar',v:data.visitorsToday,i:Users},{l:'7 kunlik tashrifchilar',v:data.visitors7,i:Eye},{l:'30 kunlik tashrifchilar',v:data.visitors30,i:MonitorSmartphone},{l:'Bugungi sahifa ko‘rishlar',v:data.pageViewsToday,i:Eye},{l:'Bugun ro‘yxatdan o‘tgan',v:data.registrations.today,i:UserPlus}];
