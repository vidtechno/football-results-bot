...
BEGIN
  ...
  FROM public.wallet_accounts
  WHERE user_id = '00000000-0000-0000-0000-000000000001' AND account_type = 'platform_commission'
  FOR UPDATE;

  IF NOT FOUND THEN
    INSERT INTO public.wallet_accounts (user_id, account_type, balance)
    VALUES ('00000000-0000-0000-0000-000000000001', 'platform_commission', 0)
